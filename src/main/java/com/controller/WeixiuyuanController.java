...
public class WeixiuyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		WeixiuyuanEntity u = weixiuyuanService.selectOne(new EntityWrapper<WeixiuyuanEntity>().eq("gonghao", username));
    ...
    public R register(@RequestBody WeixiuyuanEntity weixiuyuan){
    	...
    	WeixiuyuanEntity u = weixiuyuanService.selectOne(new EntityWrapper<WeixiuyuanEntity>().eq("gonghao", weixiuyuan.getGonghao()));
		if(u!=null) {
