<template>
	<div>
		<div class="container" :style='{"minHeight":"100vh","alignItems":"center","background":"url(http://codegen.caihongy.cn/20210128/ac0684f4d39c4b5ebf6694a20d747cd6.jpg)","display":"flex","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","justifyContent":"center"}'>
			<el-form v-if="pageFlag=='register'" :style='{"padding":"0","margin":"0","borderRadius":"0","background":"rgba(255, 255, 255, 0.5000)","flexDirection":"column","display":"flex","width":"749px","position":"absolute","right":"0","justifyContent":"center","height":"100vh"}' ref="rgsForm" class="rgs-form" :model="rgsForm">
				<div v-if="true" :style='{"margin":"0 0 30px 0","color":"#000","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"24px","fontWeight":"600","height":"auto"}' class="title">物业管理系统注册</div>
				<el-form-item :style='{"width":"45%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='wuyeguanli'">
				...
				<el-form-item :style='{"width":"45%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='yezhu'">
				...
				<el-form-item :style='{"width":"45%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='yezhu'">
					<div v-if="false" :style='{"width":"64px","lineHeight":"44px","fontSize":"14px","color":"rgba(64, 158, 255, 1)"}' class="lable">业主姓名</div>
				...
				<el-form-item :style='{"width":"45%","padding":"0","margin":"0 auto 15px","height":"auto"}' class="list-item" v-if="tableName=='weixiuyuan'">
	...
	methods: {
		...
		login() {
			var url=this.tableName+"/register";
					if((!this.ruleForm.zhanghao) && `wuyeguanli` == this.tableName){
					...
					if((!this.ruleForm.mima) && `wuyeguanli` == this.tableName){
					...
					if((this.ruleForm.mima!=this.ruleForm.mima2) && `wuyeguanli` == this.tableName){
					...
					if(`wuyeguanli` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
					...
					if(`wuyeguanli` == this.tableName && this.ruleForm.dianhua&&(!this.$validate.isMobile(this.ruleForm.dianhua))){
					...
					if(`yezhu` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
						this.$message.error(`邮箱应输入邮件格式`);
						return
					}
					...
					if((!this.ruleForm.gonghao) && `weixiuyuan` == this.tableName){
					...
					if(`weixiuyuan` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
						this.$message.error(`邮箱应输入邮件格式`);
						return
					}
...
<style lang="scss" scoped>
	.container {
	  position: relative;
	  background: url(http://codegen.caihongy.cn/20210128/ac0684f4d39c4b5ebf6694a20d747cd6.jpg);
