	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="投诉分类" prop="tousufenlei">
					<el-select :disabled="ro.tousufenlei" v-model="ruleForm.tousufenlei" placeholder="请选择投诉分类" >
						<el-option
							v-for="(item,index) in tousufenleiOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="投诉分类" prop="tousufenlei">
					<el-input v-model="ruleForm.tousufenlei"
						placeholder="投诉分类" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="投诉时间" prop="tousushijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.tousushijian" label="投诉时间" prop="tousushijian">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="处理状态" prop="chulizhuangtai">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="处理状态" prop="chulizhuangtai">
					<el-input v-model="ruleForm.chulizhuangtai"
						placeholder="处理状态" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-if="type!='info'"  label="投诉内容" prop="tousuneirong">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.tousuneirong" label="投诉内容" prop="tousuneirong">
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='tousufenlei'){
							this.ruleForm.tousufenlei = obj[o];
							this.ro.tousufenlei = true;
							continue;
						}
						if(o=='tousuneirong'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.tousuneirong = this.ruleForm.tousuneirong.replace(reg,'../../../springboot78ahx/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
