<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="小区名称" prop="xiaoqumingcheng">
					<el-input v-model="ruleForm.xiaoqumingcheng" placeholder="小区名称" clearable  :readonly="ro.xiaoqumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="小区名称" prop="xiaoqumingcheng">
					<el-input v-model="ruleForm.xiaoqumingcheng" placeholder="小区名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="小区类型" prop="xiaoquleixing">
					<el-input v-model="ruleForm.xiaoquleixing" placeholder="小区类型" clearable  :readonly="ro.xiaoquleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="小区类型" prop="xiaoquleixing">
					<el-input v-model="ruleForm.xiaoquleixing" placeholder="小区类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="物业名称" prop="wuyemingcheng">
					<el-input v-model="ruleForm.wuyemingcheng" placeholder="物业名称" clearable  :readonly="ro.wuyemingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="物业名称" prop="wuyemingcheng">
					<el-input v-model="ruleForm.wuyemingcheng" placeholder="物业名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="小区人数" prop="xiaoqurenshu">
					<el-input v-model="ruleForm.xiaoqurenshu" placeholder="小区人数" clearable  :readonly="ro.xiaoqurenshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="小区人数" prop="xiaoqurenshu">
					<el-input v-model="ruleForm.xiaoqurenshu" placeholder="小区人数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="小区位置" prop="xiaoquweizhi">
					<el-input v-model="ruleForm.xiaoquweizhi" placeholder="小区位置" clearable  :readonly="ro.xiaoquweizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="小区位置" prop="xiaoquweizhi">
					<el-input v-model="ruleForm.xiaoquweizhi" placeholder="小区位置" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="小区简介" prop="xiaoqujianjie">
					<el-input
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.xiaoqujianjie" label="小区简介" prop="xiaoqujianjie">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.xiaoqujianjie}}</span>
				</el-form-item>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				xiaoquleixing: [
					{ required: true, message: '小区类型不能为空', trigger: 'blur' },
				],
				wuyemingcheng: [
				],
				xiaoqurenshu: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='wuyemingcheng'){
							this.ruleForm.wuyemingcheng = obj[o];
							this.ro.wuyemingcheng = true;
							continue;
						}
						if(o=='xiaoqurenshu'){
