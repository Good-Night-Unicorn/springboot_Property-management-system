<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="车场名称" prop="chechangmingcheng">
					<el-input v-model="ruleForm.chechangmingcheng" placeholder="车场名称" clearable  :readonly="ro.chechangmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="车场名称" prop="chechangmingcheng">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="车场类型" prop="chechangleixing">
					<el-input v-model="ruleForm.chechangleixing" placeholder="车场类型" clearable  :readonly="ro.chechangleixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="车场类型" prop="chechangleixing">
					<el-input v-model="ruleForm.chechangleixing" placeholder="车场类型" readonly></el-input>
				</el-form-item>
