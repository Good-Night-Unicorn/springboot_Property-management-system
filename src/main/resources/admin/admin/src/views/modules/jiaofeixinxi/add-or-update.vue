<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'" label="订单编号" prop="dingdanbianhao">
					<el-input v-model="ruleForm.dingdanbianhao" placeholder="订单编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.dingdanbianhao" label="订单编号" prop="dingdanbianhao">
					<el-input v-model="ruleForm.dingdanbianhao" placeholder="订单编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="缴费名称" prop="jiaofeimingcheng">
					<el-input v-model="ruleForm.jiaofeimingcheng" placeholder="缴费名称" clearable  :readonly="ro.jiaofeimingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="缴费名称" prop="jiaofeimingcheng">
					<el-input v-model="ruleForm.jiaofeimingcheng" placeholder="缴费名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'" label="用户名" prop="yonghuming">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.yonghuming" label="用户名" prop="yonghuming">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="缴费类型" prop="jiaofeileixing">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="缴费类型" prop="jiaofeileixing">
					<el-input v-model="ruleForm.jiaofeileixing"
						placeholder="缴费类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="upload" v-if="type!='info'&& !ro.jiaofeimingxi" label="缴费明细" prop="jiaofeimingxi">
					<file-upload
						tip="点击上传缴费明细"
						action="file/upload"
						:limit="1"
						:multiple="true"
						:fileUrls="ruleForm.jiaofeimingxi?ruleForm.jiaofeimingxi:''"
						@change="jiaofeimingxiUploadChange"
					></file-upload>
				</el-form-item>  
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.jiaofeimingxi" label="缴费明细" prop="jiaofeimingxi">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","background":"rgba(121, 121, 121, 1)","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.jiaofeimingxi)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="!ruleForm.jiaofeimingxi" label="缴费明细" prop="jiaofeimingxi">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="需缴金额" prop="xujiaojine">
					<el-input v-model="ruleForm.xujiaojine" placeholder="需缴金额" clearable  :readonly="ro.xujiaojine"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="需缴金额" prop="xujiaojine">
					<el-input v-model="ruleForm.xujiaojine" placeholder="需缴金额" readonly></el-input>
				</el-form-item>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				jiaofeimingxi: [
					{ required: true, message: '缴费明细不能为空', trigger: 'blur' },
				],
				xujiaojine: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='xujiaojine'){
							this.ruleForm.xujiaojine = obj[o];
							this.ro.xujiaojine = true;
							continue;
						}
						if(o=='fabushijian'){
            ...
            this.jiaofeileixingOptions = "物业费,车位费,水费,电费,燃气费,网费,其他".split(',')
	...
	if(this.ruleForm.jiaofeimingxi!=null) {
		this.ruleForm.jiaofeimingxi = this.ruleForm.jiaofeimingxi.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    jiaofeimingxiUploadChange(fileUrls) {
	    this.ruleForm.jiaofeimingxi = fileUrls;
    },
  }
};
</script>
