	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="车位费" prop="cheweifei">
					<el-input v-model="ruleForm.cheweifei" placeholder="车位费" clearable  :readonly="ro.cheweifei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="车位费" prop="cheweifei">
					<el-input v-model="ruleForm.cheweifei" placeholder="车位费" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="备注说明" prop="beizhushuoming">
					<el-input
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.beizhushuoming" label="备注说明" prop="beizhushuoming">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.beizhushuoming}}</span>
				</el-form-item>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				cheweiquhao: [
					{ required: true, message: '车位区号不能为空', trigger: 'blur' },
				],
				cheweibianhao: [
				...
				cheweifei: [
					{ required: true, message: '车位费不能为空', trigger: 'blur' },
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='cheweifei'){
							this.ruleForm.cheweifei = obj[o];
							this.ro.cheweifei = true;
							continue;
						}
						if(o=='beizhushuoming'){
