	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="投诉分类" prop="tousufenlei">
					<el-input v-model="ruleForm.tousufenlei" placeholder="投诉分类" clearable  :readonly="ro.tousufenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="投诉分类" prop="tousufenlei">
					<el-input v-model="ruleForm.tousufenlei" placeholder="投诉分类" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="处理时间" prop="chulishijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.chulishijian" label="处理时间" prop="chulishijian">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-if="type!='info'"  label="处理结果" prop="chulijieguo">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.chulijieguo" label="处理结果" prop="chulijieguo">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.chulijieguo"></span>
                </el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.chulishijian = this.getCurDate()
	},
	methods: {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.chulijieguo = this.ruleForm.chulijieguo.replace(reg,'../../../springboot78ahx/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
